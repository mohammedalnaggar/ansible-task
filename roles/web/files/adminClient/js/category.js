...
categoryAddBtn.addEventListener("click", function (evt) {
  ...
  xhttp.open("POST", "http://172.168.0.30:5000/admin/categories");
...
function editCategories(uri) {
  ...
  xhttp.open("POST", `http://172.168.0.30:5000/admin/categories/${uri}/update`);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send(JSON.stringify({
...
function listCategories() {
  ...
  xhttp.open("GET", "http://172.168.0.30:5000/admin/categories");
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send()
};
